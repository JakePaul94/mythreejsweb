!(function (e) {
      ...
      return (
        (e.init = function () {
          (e.header = i._q("header")),
            (e.main = i._q("main")),
            e.main || (n.Template.initSlideMain(), (e.main = i._q("main"))),
            (e.footer = i._q("footer")),
            (e.canvas = i._q("#three")),
            (e.loading = i._q("#loading")),
            (e.headerHome = i._q("#header_home")),
            (e.headerAbout = i._q("#header_about")),
            (e.headerAboutSVG = e.headerAbout.querySelector(
              ".header_about_arrow svg"
            )),
            (e.headerAboutPolyline =
              e.headerAboutSVG.querySelector("polyline")),
            (e.menuTriggerOpen = i._q("#menuTrigger_open")),
            (e.menuTriggerClose = i._q("#menuTrigger_close")),
            (e.slideHome = i._q("#slideHome")),
            e.slideHome ||
              (n.Template.initSlideHome(), (e.slideHome = i._q("#slideHome"))),
            (e.slideHomeContainer = e.slideHome.querySelector(
              ".slideHome_container"
            )),
            (e.slideHomePosition = e.slideHome.querySelector(
              ".slideHome_position"
            )),
            ...
            e.slideWorks ||
              (n.Template.initSlideWorks(),
              (e.slideWorks = i._q("#slideWorks"))),
            (e.slideWorksContainer = e.slideWorks.querySelector(
              ".slideWorks_container"
            )),
            (e.slideWorksHeader =
              e.slideWorks.querySelector(".slideWorks_header")),
            (e.slideWorksNum = e.slideWorks.querySelector(".slideWorks_num")),
            (e.slideWorksCategory = e.slideWorks.querySelector(
              ".slideWorks_category"
            )),
            (e.slideWorksTitle =
              e.slideWorks.querySelector(".slideWorks_title")),
            (e.slideWorksDescription = e.slideWorks.querySelector(
            ...
            (e.slideWorksShare =
              e.slideWorks.querySelector(".slideWorks_share")),
            (e.slideWorksShareLabel = e.slideWorks.querySelector(
              ".slideWorks_share_label"
            )),
            (e.slideWorksShareFacebook = e.slideWorks.querySelector(
              ".slideWorks_share_facebook"
            )),
            (e.slideWorksShareTwitter = e.slideWorks.querySelector(
              ".slideWorks_share_twitter"
            )),
            (e.slideNavi = i._q("#slideNavi")),
            e.slideNavi ||
              (n.Template.initSlideNavi(), (e.slideNavi = i._q("#slideNavi"))),
            (e.slideNaviPrev = i._q("#slideNavi_prev")),
            (e.slideNaviPrevNum = e.slideNaviPrev.querySelector(
              ".slideNavi_num > span"
            )),
            (e.slideNaviPrevTitle = e.slideNaviPrev.querySelector(
              ".slideNavi_title > span"
            )),
            (e.slideNaviPrevSVG = e.slideNaviPrev.querySelector(
              ".slideNavi_arrow svg"
            )),
            (e.slideNaviPrevPolyline =
              e.slideNaviPrevSVG.querySelector("polyline")),
            (e.slideNaviNext = i._q("#slideNavi_next")),
            (e.slideNaviNextNum = e.slideNaviNext.querySelector(
              ".slideNavi_num > span"
            )),
            (e.slideNaviNextTitle = e.slideNaviNext.querySelector(
              ".slideNavi_title > span"
            )),
            (e.slideNaviNextSVG = e.slideNaviNext.querySelector(
              ".slideNavi_arrow svg"
            )),
            (e.slideNaviNextPolyline =
              e.slideNaviNextSVG.querySelector("polyline")),
            n.Template.initSlideNaviCount(),
            (e.slideNaviCount = i._q("#slideNavi_count")),
            (e.slideNaviCountPrev = e.slideNaviCount.querySelector(
              ".slideNavi_count_prev"
            )),
            (e.slideNaviCountNext = e.slideNaviCount.querySelector(
              ".slideNavi_count_next"
            )),
            (e.slideNaviCountTotal = e.slideNaviCount.querySelector(
              ".slideNavi_count_total"
            )),
            (e.slideInfo = i._q("#slideInfo")),
            e.slideInfo ||
              (n.Template.initSlideInfo(), (e.slideInfo = i._q("#slideInfo"))),
            (e.slideInfoScroll =
              e.slideInfo.querySelector(".slideInfo_scroll")),
            (e.slideInfoBack = e.slideInfo.querySelector(".slideInfo_back")),
            (e.slideInfoNum = e.slideInfo.querySelector(".slideInfo_num")),
            (e.slideInfoCategory = e.slideInfo.querySelector(
              ".slideInfo_category"
            )),
            (e.slideInfoTitle = e.slideInfo.querySelector(".slideInfo_title")),
            (e.slideInfoDescription = e.slideInfo.querySelector(
              ".slideInfo_description"
            )),
            (e.slideInfoShareFacebook = e.slideInfo.querySelector(
              ".slideInfo_share_facebook"
            )),
            (e.slideInfoShareTwitter = e.slideInfo.querySelector(
              ".slideInfo_share_twitter"
            )),
            n.Template.initSlideVimeo(),
            (e.slideVimeo = i._q("#slideVimeo")),
            (e.slideVimeoClose =
              e.slideVimeo.querySelector(".slideVimeo_close")),
            (e.list = i._q("#list")),
            ...
            (e.about = i._q("#about")),
            e.about ||
              (n.Template.initSlideAbout(), (e.about = i._q("#about"))),
      ...
      f = (function (e) {
          ...
          return (
            (t._onChangePath = function () {
              ...
              "/about/" == o
                ...
                : "/works/" == o
                ? (n = "Works | " + n)
                : -1 != (e = t.getWorksIndexByPath(o)) &&
                  (n = d.ConstWork.list[e].title + " | " + n),
                (document.title = n);
            }),
            t
          );
        ...
        return (
          ...
          (o.prototype.initModel = function () {
            var e = this.get("path");
            this.isList(e)
              ? u.modelState.set({ isList: !0, isSlide: !1 })
              : u.modelState.set({
                  isList: !1,
                  isSlide: !0,
                  zoomTarget: e,
      ...
      a = (function (e) {
        ...
        return (
          ...
          (t.prototype.stop = function () {
            return (
              TweenMax.ticker.removeEventListener("tick", this._onTick, this),
          ...
          (t.prototype._setRatio = function () {
            this.set({ ratio: Math.min(s, window.devicePixelRatio) || 1 });
          }),
          (t.prototype._onTick = function () {
            var e = TweenMax.ticker.time;
            e - i > 0.5 && ((i = e), this._setRatio());
          }),
          t
        );
      })(r.Model);
  ...
  function (e, t, o) {
    ...
    var i = o(8),
      ...
      d = o(39),
      h = o(27),
      p = (1 / Math.tan((30 * Math.PI) / 180)) * 0.5,
      f = (function (e) {
        function t() {
          var t = (null !== e && e.apply(this, arguments)) || this;
          return (
    ...
    var n = (function () {
      ...
      return (
        ...
        (e.prototype.trigger = function (e, t) {
          ...
          if (!(i = this.typeList)) return this;
          if (!(r = i[e])) return this;
          for (r = r.concat(), n = r.length, o = 0; o < n; o++)
            (s = r[o]),
              (a = s.listener),
              a.apply(s.context, t),
  ...
  function (e, t, o) {
    ...
    function n(e, t) {
      ...
      for (n = e.length, r = t.length, o = 0; o < n; o++)
        for (s = e[o], i = 0; i < r; i++) if (t[i] == s) return !0;
      return !1;
    }
    function i(e, t, o) {
      var n, i, r, s, a, l, u;
      for (s = Object.keys(t), i = s.length, r = [], n = 0; n < i; n++)
        (a = s[n]) in e &&
          ((l = e[a]),
          (u = t[a]),
          (o[a] = l),
        ...
        return (
          ...
          (t.prototype.set = function (e, t) {
            e &&
              ...
              0 != this._changedKeys.length &&
                (t.silent ||
                  (this.triggers(this._findTypes(this._changedKeys)),
                  this.trigger(":"))));
          }),
          ...
          (t.prototype.changedAny = function (e) {
            ...
            for (o = e.length, t = 0; t < o; t++)
              if (((n = e[t]), -1 != this._changedKeys.indexOf(":" + n)))
                return !0;
            return !1;
          }),
          ...
          (t.prototype._findTypes = function (e) {
            ...
            if (this.typeList && e && 0 != e.length) {
              for (
                t = Object.keys(this.typeList), a = [], s = t.length, r = 0;
                r < s;
                r++
              )
                (o = t[r]), (i = o.split(" ")), n(i, e) && a.push(o);
              return a;
            }
          }),
          t
  ...
  function (e, t, o) {
          ...
          return (
            ...
            (t._onPreloadJSON = function () {
              p.ConstConfig.init(Q.preloadJSON.json),
                (i = new imagesLoaded(document, { background: !1 })),
                i.on("always", t._onPreloadImages1);
            }),
            (t._onPreloadImages1 = function () {
              Useragnt.pc &&
                !Useragnt.mac &&
                (M.smoothScroll.init().start(),
            ...
            (t._onPreloadImages2 = function () {
              Useragnt.ios && j.modelMQ.on(":", t._onMQ),
                ...
                b.pointer.start(),
                N.C.canvasTextUsing
                  ? (U.modelState.once("canvasDraw", t._onDrawCanvas),
                    I.CanvasText.draw())
                  : t._onDrawCanvas();
            }),
            (t._onDrawCanvas = function () {
              L.VideoPlayer.init(),
                ...
                N.C.videoUsing
                  ? (f.controllerPreloadVideo.on("ready", t._ready),
                    f.controllerPreloadVideo.init())
                  : t._ready();
            }),
            (t._ready = function () {
              D.modelSlide.init(),
            ...
            (t._opening = function () {
              h.routeManagerPlus.initModel(),
                ...
                TimelinePlus.call(t._start).delay(
                  U.modelState.get("isSlide") ? 1 : 0.3
                );
            }),
            (t._start = function () {
            ...
            (t._onResize = function () {
              ...
              var n = window
                .getComputedStyle(C.Q.head, "")
                .fontFamily.replace(/["']/g, "");
              j.modelMQ.set({ breakpoint: n }),
                t.trigger("resize:1"),
                t.trigger("resize");
            }),
            (t._onMQ = function () {
        ...
        return (
          ...
          (t.prototype.init = function () {
            ...
            e.parentNode.removeChild(e),
              a.SC.init(),
              TweenMax.set([a.SC.list, a.SC.about], { autoAlpha: 0 }),
    ...
    l.ready(function () {
      console.log("made by http://homunculus.jp/"),
        Allocatr.primary && ((t.index = new X()), t.index.init());
    }),
      ...
      a = (function (e) {
        function t(o, n) {
          ...
          (i.indexSlide = o + 1),
            ...
            r.C.videoUsing
              ? (i.urlThumb = r.C.path + "/images/shot/" + i.slug + ".jpg")
              : (i.urlThumb = r.C.path + "/images/still/" + i.slug + ".jpg");
          var a = r.C.origin + i.path;
          return (
            (i.shareFacebook = s.Share.generateFacebook(a)),
    ...
    var i = o(5),
      ...
      l = (function (e) {
            ...
            (i._play = function (e) {
              void 0 === e && (e = !1),
                ...
                i.video &&
                  i.video.paused &&
                  !i.isPlaying &&
                  (e || (i.video.currentTime = 0), i.video.play());
            }),
        ...
        return (
          ...
          (t.init = function () {
            var e, o, n;
            for (this.list = [], o = a.ConstSlide.num, e = 0; e < o; e++)
          ...
          (t.prototype.play = function (e, t) {
            void 0 === e && (e = 0),
              ...
              e
                ? (this._tween = TimelinePlus.call(this._play, [t], this).delay(
                    e
                  ))
                : this._play(t);
          }),
    ...
    var i = o(6),
      ...
      u = (function (e) {
        ...
        return (
          ...
          (t.prototype.init = function () {
            var e, t;
            for (t = r.SC.listItems.length, this.items = [], e = 0; e < t; e++)
              this.items[e] = new s.ModelListItem(
                e,
                r.SC.listItems[e],
                r.SC.listButtons[e],
                r.SC.listImages[e],
                l.VideoPlayer.list[e + 1]
              );
    ...
    var i = o(6),
      ...
      l = (function (e) {
        ...
        return (
          n(t, e),
          (t.prototype.defaults = function () {
            return { visible: !1, texture1: -1, texture2: -1 };
          }),
          (t.prototype.init = function () {
            var e, t;
            for (t = r.ConstSlide.num, this.uvList = [], e = 0; e < t; e++)
              this.uvList[e] = { u: 1, v: 1, s: 1, t: 1 };
    ...
    var i = o(6),
      ...
      s = (function (e) {
        ...
        return (
          n(t, e),
          (t.prototype.defaults = function () {
            return { zoomCancel: !1, zoom: !1, visible: !1, play: !1 };
          }),
          (t.prototype.init = function () {
        ...
        return (
          ...
          (t.prototype._initThree = function () {
            (this.geometry = new THREE.PlaneBufferGeometry(1, 1, 1, 1)),
              (this.textureCurrent = new THREE.Texture(
                null,
                null,
              ...
              (this.textureNext = new THREE.Texture(
                null,
                null,
                THREE.ClampToEdgeWrapping,
                THREE.ClampToEdgeWrapping,
            ...
            var e = {
                time: { value: l.uniformTime.value },
                texture: { value: this.textureCurrent },
                opacity: { value: 1 },
                progress: { value: 0 },
                offset: { value: new THREE.Vector3(0, 0, 10) }
              },
              t = {
                time: { value: l.uniformTime.value },
                texture: { value: this.textureNext },
                opacity: { value: 1 },
                progress: { value: 0 },
                offset: { value: new THREE.Vector3(0, 0, 10) }
              },
        ...
        function t(t) {
          ...
          return (
            (o._onMouseOver = function (e) {
              ...
              (t && (t === o.element || o.element.contains(t))) ||
                o.trigger("mouseenter", [e]);
            }),
            (o._onMouseOut = function (e) {
              var t = e.relatedTarget;
              (t && (t === o.element || o.element.contains(t))) ||
                o.trigger("mouseleave", [e]);
            }),
            (o.element = t),
            o
          );
    ...
    var i = o(6),
      ...
      a = (function (e) {
        ...
        return (
          ...
          (t.prototype.start = function () {
            return (
              window.addEventListener("mousemove", this._onMouseMove), this
            );
          }),
          (t.prototype.stop = function () {
            return (
  ...
  function (e, t, o) {
    ...
    function i(e) {
      ...
      if (
        (_.push({ y: e, lastY: e < 0 ? 0.99 : -0.99, start: Date.now() }), !g)
      ) {
        var s = function () {
        ...
        return (
          ...
          (t.draw = function () {
            ...
            (m = 0),
              ...
              (_ = 0),
              (g = 0),
              (i = TimelinePlus.call(t._draw).delay(0.1));
          }),
          (t._draw = function () {
            var e;
            if (v < l.ConstSlide.num)
              (e = t.list[v]),
                e.drawCapture(),
                _ < e.originalHeight && ((_ = e.originalHeight), (g = v)),
                i && i.kill(),
                (i = TimelinePlus.call(t._draw).delay(0.1));
            else {
              if ((t._copy(), 0 == m))
                return (
                  h.Q.html.classList.remove("isDrawingL"),
                  ...
                  (m = 1),
                  i && i.kill(),
                  void (i = TimelinePlus.call(t._draw).delay(0.1))
                );
              t._destroy(),
          ...
          (t._copy = function () {
            ...
            for (
              ...
              (n = t.list[e]), n.drawTexture(), (i.list[e] = n.canvasTexture);
          }),
          (t._destroy = function () {
            var e, o, n;
            for (o = l.ConstSlide.num, e = 0; e < o; e++)
              (n = t.list[e]), n.destroy(), (t.list[e] = null);
            t.list = null;
          }),
          ...
          (t.prototype.drawCapture = function () {
            0 == this.indexSlide
              ? u.captureHome(this)
              : u.captureWork(this, c.ConstWork.list[this.indexSlide - 1]);
          }),
          (t.prototype.drawTexture = function () {
            ...
            (this.canvasTexture = document.createElement("canvas")),
              ...
              this.contextTexture.drawImage(
                this.canvas,
                0,
                (t * f - this.originalCanvasHeight) / 2,
      ...
      c = (function (e) {
        ...
        return (
          ...
          (t.prototype._initGeometry = function () {
            ...
            for (
              s[0] = s[1] = s[2] = 0, s[3] = s[4] = s[5] = 0, e = 0;
              e < 129;
              e++
            ) {
              switch (
                ...
                (n = Math.floor(e / 32) % 4),
                (i = (e % 32) / 32 - 0.5),
                (s[t + 0] = 0.5 * Math.cos(o)),
                (s[t + 1] = 0.5 * Math.sin(o)),
                (s[t + 2] = 0),
                n)
              ) {
                case 0:
            ...
            r.addAttribute(
              "position",
              new THREE.InterleavedBufferAttribute(l, 3, 0, !1)
            ),
              r.addAttribute(
                "position2",
                new THREE.InterleavedBufferAttribute(l, 3, 3, !1)
              ),
              (this.geometry = r);
          }),
          (t.prototype._initMesh = function () {
            var e = {
                time: { value: a.uniformTime.value },
                size: { value: l.uniformSize.value },
                center: { value: new THREE.Vector2() },
                progress: { value: new THREE.Vector4(0, 0, 0, 0) },
                corners: { value: new THREE.Vector4(1, 1, 1, 1) },
                opacity: { value: 1 }
              },
    ...
    var i = o(4),
      ...
      d = (function (e) {
        ...
        return (
          ...
          (t.prototype.init = function () {
            return (
              (this.model = a.modelSlide),
              this._initThree(),
              (this.controller = new c.ControllerThreeSlide(this)),
              (this.controllerTexture = new s.ControllerThreeSlideTexture(
                this
              )),
              this
            );
          ...
          (t.prototype._initThree = function () {
            ...
            var e = {
                time: { value: l.uniformTime.value },
                pixels: { value: u.uniformPixels.value },
                texture1: {
      ...
      (t.Random = {
        ...
        ranges: function (e, t, o) {
          void 0 === e && (e = 0),
            ...
            0 == o && (o = 1 / Number.MAX_VALUE);
          var n = Math.random() * (t - e) + e;
          return Math.round(n / o) * o * (Math.random() < 0.5 ? 1 : -1);
        }
      });
  },
  function (e, t, o) {
    ...
    function i(e, t) {
      void 0 === t && (t = 0);
      var o, i, r, s;
      for (r = n(e, t), s = []; (o = r.length); )
        (i = (Math.random() * o) | 0), s.push(r.splice(i, 1)[0]);
      return s;
    }
    Object.defineProperty(t, "__esModule", { value: !0 }),
    ...
    var r = (function () {
      ...
      return (
        ...
        (e.prototype._random = function () {
          (this._indexList && this._indexList.length > 0) ||
            ((this._indexList = i(this._length)),
            this._index === this._indexList[0] &&
              (this._indexList = this._indexList.reverse()));
        }),
        e
      );
    })();
      ...
      s = (function (e) {
        ...
        return (
          ...
          (t.prototype.add = function () {
            this.trigger("update"), ++r > 1 || this.set({ running: !0 });
          }),
          (t.prototype.remove = function () {
            r > 0 && --r, r > 0 || this.set({ running: !1 });
          }),
          t
        );
      })(i.Model);
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }),
      (t.Style = {
        size: function (e, t, o) {
          ...
          if (e)
            for (
              void 0 === e.length && (e = [e]), i = e.length, n = 0;
              n < i;
              n++
            )
              (r = e[n]),
        ...
        positionLT: function (e, t, o) {
          ...
          if (e)
            for (
              ...
              (r = e[n]), (r.style.left = t + "px"), (r.style.top = o + "px");
        },
        positionRT: function (e, t, o) {
          ...
          if (e)
            for (
              ...
              (r = e[n]), (r.style.right = t + "px"), (r.style.top = o + "px");
        },
        display: function (e, t) {
          var o, n, i;
          if (e)
            for (
              void 0 === e.length && (e = [e]), n = e.length, o = 0;
              o < n;
              o++
            )
              (i = e[o]), (i.style.display = t);
        }
      });
  },
  function (e, t, o) {
    ...
    var n,
      ...
      a = (function () {
        function e() {
          this._onMouseEnter = function (e) {
            var t,
              ...
              a = e.currentTarget;
            for (
              s.routeManagerPlus.trigger("loop"),
            ...
            (r = TimelinePlus.seri(
              TimelinePlus.call(a.classList.add, ["isHover"], a.classList),
              TimelinePlus.wait(1),
              TimelinePlus.call(a.classList.remove, ["isHover"], a.classList)
            ).delay(2 / 60)),
              (i.tween = r);
          };
        }
        return (
          (e.prototype.init = function () {
            var e, t, o;
            for (n = [], t = i.SC.buttonHover.length, e = 0; e < t; e++)
          ...
          (this._onLoop = function () {
            ...
            (this._loop = function () {
              r.Q.html.classList.remove("isLoop"),
                TimelinePlus.seri(
                  TimelinePlus.call(
                    r.Q.html.classList.add,
                    ["isLoop"],
                    r.Q.html.classList
                  ),
                  TimelinePlus.wait(0.8),
                  TimelinePlus.call(
                    r.Q.html.classList.remove,
                    ["isLoop"],
                    r.Q.html.classList
                  )
                ).delay(2 / 60);
      ...
      i = (function () {
        function e() {
          this._onBreakpooint = function () {
            ...
            t
              ? ((o = "computer"),
                (i = "large" == e || "medium" == e ? "large" : "short"))
              : ("tablet_l" != e && "tablet_p" != e) || (o = "tablet");
            var r = 0;
      ...
      s = (function () {
        function e() {
          (this._onChangeSlide = function () {
            r.modelState.get("isSlide") ||
              n.SC.menuTriggerClose.setAttribute(
                "href",
                r.modelState.get("zoomTarget") || "/"
              );
          }),
        ...
        return (
          (e.prototype.init = function () {
            n.SC.menuTriggerOpen.addEventListener("click", this._onClickOpen),
              n.SC.menuTriggerClose.addEventListener(
                "click",
                this._onClickClose
              ),
        ...
        function e() {
          ...
          (this._onStart = function () {
            i.routeManagerPlus.on(":path", e._onRoute),
              ...
              "/about/" == i.routeManagerPlus.get("path") && e._scroll(0.5);
          }),
        ...
        return (
          ...
          (e.prototype._scroll = function (e) {
            ...
            var t = s.SC.about.offsetTop,
              o =
                t -
                a.resize.get("innerHeight") / 2 +
                s.SC.about.clientHeight / 2;
            TweenMax.to(window, 0.6, {
              scrollTo: { y: Math.min(t, o), autoKill: !1 },
        ...
        function e() {
          (this._onClickHome = function (e) {
            ...
            (this._onClickAbout = function (e) {
              e.preventDefault(),
                "/about/" == i.routeManagerPlus.get("path")
                  ? i.routeManagerPlus.trigger("about")
                  : i.routeManagerPlus.goto("/about/", null, !0);
            }),
            (this._onChangeDevice = function () {
              var e, t;
              r.modelMQ.get("mobile")
                ? ((e = "0 0 23 5"), (t = "0,5 23,5 8,0 8,4 0,4"))
                : ((e = "0 0 45 7"), (t = "0,7 45,7 24,0 24,6 0,6")),
  ...
  function (e, t, o) {
    ...
    var n,
      ...
      f = (function () {
        function e() {
          this._onStart = function () {
            p.modelState.get("isList") &&
              TweenMax.to([s.SC.list, s.SC.about], 0.5, {
                autoAlpha: 1,
        ...
        return (
          (e.prototype.init = function () {
            var e, t, o;
            for (
              t = s.SC.listItems.length, n = [], i = [], r = [], e = 0;
              e < t;
              e++
            )
  ...
  function (e, t, o) {
    ...
    function n(e, t) {
      var o,
        ...
        i = [e];
      for (o = 1; o < t; o++)
        (n = e + o), n < t - 1 && i.push(n), (n = e - o) >= -1 && i.push(n);
      return i;
    }
    var i =
      (this && this.__extends) ||
        ...
        function e() {
          ...
          (this._onStart = function () {
            l.modelState.on(":isSlide", e._onChangeSlide),
              e._onChangeSlide(),
              Useragnt.pc ||
                l.modelState.on(":isSlideInfo", e._onChangeSlideInfo);
          }),
            (this._onChangeSlide = function () {
              l.modelState.get("isSlide")
                ? (Useragnt.pc ||
                    (window.removeEventListener("touchmove", e._onTouchMove),
                  ...
                  Useragnt.ios &&
                    Useragnt.mobile &&
                    ((n = TimelinePlus.seri(
                      TimelinePlus.wait(0.2),
                      TimelinePlus.call(e._onResize)
                    )),
                ...
                : (window.scrollTo(0, 0),
                  ...
                  Useragnt.ios &&
                    Useragnt.mobile &&
                    (n && n.kill(), d.index.off("resize", e._onResize)));
            }),
            (this._onChangeSlideInfo = function () {
              l.modelState.get("isSlideInfo")
                ? window.removeEventListener("touchmove", e._onTouchMove)
                : (window.removeEventListener("touchmove", e._onTouchMove),
                  window.addEventListener("touchmove", e._onTouchMove, {
                    passive: !1
            ...
            (this._onResize = function () {
              c.modelMQ.get("landscape")
                ? (window.scrollTo(0, 0),
                  (u.SC.main.style.height = window.innerHeight + "px"))
                : (u.SC.main.style.height = null);
            });
        }
        return (
          (e.prototype.init = function () {
          ...
          (this.positionTarget = 0),
            (this._onStart = function () {
              a.routeManagerPlus.on(":path", e._onChangeRoute),
                ...
                u.modelState.get("isSlide")
                  ? (e.enable(0.5), e.start())
                  : (e.disable(), e.stop());
            }),
            (this._onChangeSlideIndex = function () {
              (j = 0),
                i && i.kill(),
                (i = TimelinePlus.call(e._onChangeSlideComplete).delay(0.7)),
                W || u.modelState.set({ isSlideNavi: !1, isSlideText: !1 });
            }),
            (this._onChangeSlideComplete = function () {
              var t = u.modelState.get("slideIndex");
              a.routeManagerPlus.gotoSlide(t, !1),
                u.modelState.set({ isSlideText: !0 }),
                i && i.kill(),
                (i = TimelinePlus.call(e._onChangeSlideComplete2).delay(0.4));
            }),
            (this._onChangeSlideComplete2 = function () {
              u.modelState.set({ isSlideNavi: !0 });
            }),
                  ...
                  o != n
                    ? ((V = 0.075),
                      "/" == o
                        ? e._targetTween(0)
                        : e._targetTween(
                            a.routeManagerPlus.getWorksIndexByPath(o) + 1
                          ))
                    : e.enable())
                : (e.disable(), e.stop());
            }),
            (this._onChangeStateSliding = function () {
              if (!u.modelState.get("isSliding")) {
                ...
                if (!t || !o) return;
                a.routeManagerPlus.isList(e) &&
                  u.modelState.set({
                    isSlide: !1,
                    zoomTarget: a.routeManagerPlus.getPathBySlideIndex(
                      u.modelState.get("slideIndex")
                    )
                  });
              }
            }),
            (this._onChangeRoute = function () {
              ...
              o &&
                n &&
                (a.routeManagerPlus.isSlide(t)
                  ? ((V = 0.15),
                    "/" == t
                      ? e._targetTween(0)
                      : e._targetTween(
                          a.routeManagerPlus.getWorksIndexByPath(t) + 1
                        ))
                  : ((u.modelState.slideDir = 1),
                    i
                      ? ((V = 0.5), e._currentTween())
                      : u.modelState.set({
                          isSlide: !1,
                          zoomTarget: a.routeManagerPlus.getPathBySlideIndex(
                            u.modelState.get("slideIndex")
            ...
            (this._onRAF = function (t, o) {
              ...
              if (W) R += (e.positionTarget - R) * V * n;
                ...
                ((O = O < 0 ? Math.max(O, -y) : Math.min(O, y)),
                (k += O * n),
                (k += E * n),
              ...
              var i = Math.round(R);
              Math.abs(i - R) < 0.001
                ? ((R = i), u.modelState.set({ isSliding: !1 }))
                : u.modelState.set({ isSliding: !0 }),
                e._calc(),
                h.modelSlide.set({ texture1: I - 1, texture2: A - 1 }),
                (s.threeSlide.uniforms.progress.value = L),
                W ||
                  ((u.modelState.slideDir = k < 0 ? -1 : 1),
                  u.modelState.set({ slideIndex: L < 0.5 ? I : A }));
            }),
            (this._onChangeSlideInfo = function () {
            ...
            (this._onChangeSlideNavi = function () {
              u.modelState.get("isSlideNavi")
                ? l.threeManager.off("draw", e._onRAFCount)
                : l.threeManager.on("draw", e._onRAFCount);
            }),
            (this._onRAFCount = function () {
              var e, t;
              (d.SC.slideNaviCountPrev.textContent =
                m.ConstSlide.list[I].idString),
                (d.SC.slideNaviCountNext.textContent =
                  m.ConstSlide.list[A].idString),
                (e = L),
        ...
        return (
          (e.prototype.init = function () {
            (P = m.ConstSlide.num),
              ...
              (d.SC.slideNaviCountTotal.textContent = (
                "000" + f.ConstWork.num
              ).slice(-3)),
              u.modelState.get("isSlide")
                ? h.modelSlide.set({ visible: !0 })
                : h.modelSlide.set({ visible: !1 }),
              u.modelState.once("start", this._onStart);
          }),
          (e.prototype.start = function () {
            (N = !1),
              l.threeManager.on("draw", this._onRAF),
              (R = a.routeManagerPlus.getSlideIndexByPath(
                u.modelState.get("zoomTarget")
              )),
              this._calc(),
              u.modelState.set({ slideIndex: R }),
              h.modelSlide.set(
                { texture1: R - 1, texture2: R - 1 },
                { silent: !0 }
              ),
              h.modelSlide.set({ visible: !0 });
          }),
          ...
          (e.prototype.enable = function (e) {
            void 0 === e && (e = 0),
              ...
              F ||
                (e > 0
                  ? TimelinePlus.call(this._resume, null, this).delay(e)
                  : this._resume()),
              u.modelState.set({ isSlideText: !0 }),
              i && i.kill(),
              (i = TimelinePlus.call(this._onChangeSlideComplete2).delay(0.4)),
              Useragnt.ios &&
                TimelinePlus.call(v.resize.resize, null, v.resize).delay(1);
          }),
          (e.prototype.disable = function () {
            (W = !0),
              (k = 0),
              this._pause(),
              u.modelState.set({ isSlideText: !1, isSlideNavi: !1 }),
              i && i.kill(),
              n && n.kill();
          }),
          ...
          (e.prototype._resume = function () {
            (j = 0),
              c.smoothScroll.isStart
                ? ((c.smoothScroll.wheelTime = 150),
                  c.smoothScroll.on("scroll", this._onSmoothScroll))
                : window.addEventListener("wheel", this._onWheel, {
                    passive: !0
                  }),
          ...
          (e.prototype._pause = function () {
            c.smoothScroll.isStart
              ? ((c.smoothScroll.wheelTime = 1e3),
                c.smoothScroll.off("scroll", this._onSmoothScroll))
              : window.removeEventListener("wheel", this._onWheel, {
                  passive: !0
                }),
          ...
          (e.prototype._targetTween = function (e) {
            ...
            (u.modelState.slideDir = r > 0 ? 1 : -1),
              ...
              (n = TimelinePlus.seri(
                ...
                TimelinePlus.wait(0.2),
                TimelinePlus.call(this.enable, null, this)
              ));
          }),
          (e.prototype._currentTween = function () {
            var e = Math.round(R),
              t = ((e % P) + P) % P;
            u.modelState.set({ slideIndex: t }),
              this.disable(),
              (this.positionTarget = R),
              (n = TimelinePlus.seri(
          ...
          (t.prototype.load = function () {
            ...
            for (n = [], e = 0; e < r; e++)
              (o = s.ConstSlide.list[e]),
                ...
                (o.imgThumb = t),
                n.push(t);
            (i = new imagesLoaded(n, { background: !1 })),
        ...
        return (
          ...
          (t.prototype._loadXHR = function (e) {
            (i = new XMLHttpRequest()),
              1 == ("string" == typeof i.responseType ? 2 : 1) &&
      ...
      h = (function (e) {
        ...
        return (
          ...
          (t.prototype._initThree = function () {
            ...
            var e = {
                time: { value: c.uniformTime.value },
                pixels: { value: d.uniformPixels.value },
                texture: { value: this.texture },
                uvRate: { value: new THREE.Vector4(1, 1, 1, 1) },
                progress: { value: 0 },
                translateDelay: { value: new THREE.Vector4(0.05, 0.5, 0, 0.5) },
                accel: { value: new THREE.Vector2(0.5, 4) },
                waveAmpFreq: { value: new THREE.Vector4(0.1, 0.4, 4, 4) },
                waveSpeedBlend: { value: new THREE.Vector4(0, 0.3, 0.1, 1) }
              },
              t = new THREE.RawShaderMaterial({
                blending: THREE.NormalBlending,
                side: THREE.FrontSide,
    ...
    var n,
      ...
      l = (function () {
        ...
        return (
          (e.prototype.init = function () {
            var e, t;
            for (t = s.SC.listItems.length, n = [], e = 0; e < t; e++)
              n[e] = new i.ThreeListItem(
                r.modelList.items[e],
                a.ConstWork.list[e]
              );
  ...
  function (e, t, o) {
    ...
    function n(e, t, o, n) {
      ...
      for (
        ...
        for (a = p[u], h = a.length, v = !0, m = "", c = 0; c < h; c++)
          (l = a.substr(c, 1)),
            (m += v ? r + l + s : i + l + s),
            (v = " " == l);
        f[u] = m;
        ...
        return (
          ...
          (t.prototype.goto = function (e, t, o) {
            if (
              ...
              var n = t ? e + "#" + t : e;
              i != n
                ? (history.pushState({}, "", r + n), this._route(o))
                : t && this._hash();
            }
          }),
          (t.prototype.pause = function () {
            ...
            if (s) {
              ...
              null != l
                ? ((e = { path: l, pop: a }),
                  null != u && (e._hash = u),
                  this.set(e))
                : null != u && (this.set({ hash: u }), this.trigger("hash"));
            }
          }),
          ...
          (t.prototype._route = function (e) {
            ...
            (i = t + o),
              ...
              s
                ? ((a = e), (l = t), (u = o))
                : this.set({ pop: e, path: t, hash: o });
          }),
          (t.prototype._hash = function () {
            var e = location.hash.replace(/#/, "");
            s ? (u = e) : (this.set({ hash: e }), this.trigger("hash"));
          }),
          t
        );
      })(c.Model);
          ...
          return (
            ...
            (n._start = function () {
              window.addEventListener("touchend", n._onTouchEnd),
                n._passive
                  ? window.addEventListener("touchmove", n._onTouchMove)
                  : window.addEventListener("touchmove", n._onTouchMove, {
                      passive: !1
                    }),
            ...
            (n._onTouchStart = function (e) {
              ...
              1 == t
                ? (n._start(),
                  (n._touch = o[0]),
                  n.trigger("touchstart", [n._touch]))
                : (n._touch && n.trigger("touchend", [n._touch]),
                  n._stop(),
                  (n._touch = null));
            }),
  ...
  function (e, t, o) {
    ...
    function r(e, t, o, n, i) {
      ...
      for (
        var r = e.querySelectorAll("span"), s = r.length, a = 0;
        a < s;
        a++
      ) {
        var d = r[a],
        ...
        if ("" != h) {
          ...
          c.fillText(h, (p + n) * l, (f + i + 0.72 * m) * l, u.width);
        }
      }
    }
    function s(e, t) {
    ...
    function a(e) {
      ...
      (v = d.SC.slideHomePosition.innerHTML),
        ...
        (d.SC.slideHomePosition.innerHTML = h.splitTextElement(
          "Filmmaker",
          "span"
        )),
        (d.SC.slideHomeName.innerHTML = h.splitTextElement(
          "TAO TAJIMA",
          "span"
        )),
        (d.SC.slideHomeFrom.innerHTML = h.splitTextElement(
          "from TANGRAM co.ltd.",
          "span"
        ));
      ...
      s = (function (e) {
        function t(t) {
          ...
          return (
            ...
            (o.path = "/"),
            (o.videoNum =
              Math.floor(Math.random() * t.vimeo_digest.length) + 1),
            (o.videoLocal = r.C.path + "/video/home_" + o.videoNum + ".mp4"),
            (o.videoVimeo = r.C.videoLocal
              ? o.videoLocal
              : t.vimeo_digest[o.videoNum - 1]),
            (o.stillNum = Math.floor(Math.random() * t.still_num) + 1),
            r.C.videoUsing
              ? (o.urlThumb =
                  r.C.path + "/images/shot/home_" + o.videoNum + ".jpg")
              : (o.urlThumb =
                  r.C.path + "/images/still/home_" + o.stillNum + ".jpg"),
            o
          );
        }
        return n(t, e), t;
    ...
    var n,
      ...
      s = (function () {
        ...
        return (
          (e.prototype.init = function () {
            n = [
              new r.ControllerAboutScrollItem(
                i.SC.about.querySelector(".about_position"),
                0
              ),
              new r.ControllerAboutScrollItem(
                i.SC.about.querySelector(".about_name"),
                1
              ),
              new r.ControllerAboutScrollItem(
                i.SC.about.querySelector(".about_from"),
                2
              ),
              new r.ControllerAboutScrollItem(
                i.SC.about.querySelector(".about_description"),
                3
              ),
              new r.ControllerAboutScrollItem(
                i.SC.about.querySelector(".about_sns"),
                3.5
              ),
              new r.ControllerAboutScrollItem(
                i.SC.about.querySelector(".about_contact"),
                4
              )
            ];
          }),
        ...
        function e(e, t) {
          ...
          (this._onDevice = function () {
            ...
            (this._onResize = function () {
              o._updateLayout(),
                o._onScroll(),
                i.resize.changed("clientWidth") &&
                  ((o.currentY = o.targetY),
                  TweenMax.set(o.element, { y: o.currentY }));
            }),
            (this._onScroll = function () {
              var e, t;
              if (
                ((e = r.scrollerY.attrs.y),
                (t = o.position - e),
                e > o.max || e < o.min)
              ) {
                if (o.hidden) return;
              ...
              o.hidden &&
                ...
                (o.currentY =
                  t > 0
                    ? o.height + o.offsetMax * o.offsetRate
                    : -o.height + o.offsetMin * o.offsetRate),
                TweenMax.set(o.element, { y: o.currentY })),
                t > 0
                  ? t < o.area
                    ? (t = 0)
                    : (t -= o.area)
                  : t < 0 && (t > -o.area ? (t = 0) : (t += o.area)),
                (o.targetY = t * u),
            ...
            (this._onRAF = function () {
              ...
              (e = o.targetY - o.currentY),
                (t = Math.abs(e)),
                t < 0.2
                  ? ((o.currentY = o.targetY), s.raf.off("raf", o._onRAF))
                  : (o.currentY += e * c),
                TweenMax.set(o.element, { y: o.currentY });
            }),
            (this.element = e),
    ...
    var n,
      ...
      l = (function () {
        function e() {
          (this._onMouseEnter = function () {
            a.routeManagerPlus.trigger("loop"),
              ...
              (n = TimelinePlus.seri(
                TimelinePlus.call(
                  r.SC.backToTop.classList.add,
                  ["isHover"],
                  r.SC.backToTop.classList
                ),
                TimelinePlus.wait(0.5),
                TimelinePlus.call(
                  r.SC.backToTop.classList.remove,
                  ["isHover"],
                  r.SC.backToTop.classList
                )
              ).delay(2 / 60));
        ...
        return (
          (e.prototype.init = function () {
            Useragnt.pc &&
              ((i = new s.ElementEvent(r.SC.backToTop)),
              ...
              (e = a.scrollerY.attrs.y),
                ...
                t != i &&
                  (t
                    ...
                    : l.SC.backToTop.classList.add("isShow")),
                (i = t);
            });
        }
        return (
            ...
            (this._onChangeRoute = function () {
              ...
              o && "/" == t
                ? (i.modelState.set({
                  ...
                  e.model.set({ zoom: !0, zoomCancel: !1 }))
                : r && "/" == a && n.routeManagerPlus.isList(t)
                ? (i.modelState.set({ isZoomIn: !1, isZoomOut: !0 }),
                  e.model.set({ zoom: !1, zoomCancel: !0 }))
                : s &&
                  "/" == a &&
                  n.routeManagerPlus.isSlide(t) &&
                  (i.modelState.set({ isZoomIn: !0, isZoomOut: !1 }),
                  e.model.set({ zoom: !0, zoomCancel: !0 }));
            }),
            (this._onChangeStateSlide = function () {
              var t = n.routeManagerPlus.get("path"),
              ...
              o
                ? e.model.get("zoom") && e.model.trigger("zoomOut")
                : n.routeManagerPlus.isList(t) &&
                  "/" == r &&
                  (i.modelState.set({ isZoom: !0, isZoomOut: !0 }),
                  e.model.trigger("zoomIn"),
                  e.model.set({ zoom: !1, zoomCancel: !1 }));
            });
        }
        return (
          (e.prototype.init = function () {
            return (
              (this.model = r.modelHome),
              ...
              (e = s.scrollerY.attrs.y),
                ...
                t != i &&
                  (t
                    ...
                    : l.SC.listHome.classList.add("isShow")),
                (i = t);
            });
        }
        return (
        ...
        function t(t) {
          ...
          return (
            ...
            (o._onJudgeEnabled = function () {
              l.modelState.get("isList") && u.modelMQ.get("computer")
                ? o._start()
                : o._stop();
            }),
            ...
            (o._onMouseEnter = function (e) {
              (d = 0.1), o._onMouseMove(e), o.model.set({ hover: !0 });
            }),
        ...
        function t(t) {
          ...
          return (
            (o._onChangeRoute = function () {
              ...
              t && e == o.model.path
                ? (s.modelState.set({
                  ...
                  o.model.set({ zoom: !0 }))
                : n && a == o.model.path && r.routeManagerPlus.isList(e)
                ? (s.modelState.set({ isZoomIn: !1, isZoomOut: !0 }),
                  o.model.set({ zoom: !1 }))
                : i &&
                  a == o.model.path &&
                  r.routeManagerPlus.isSlide(e) &&
                  (s.modelState.set({ isZoomIn: !0, isZoomOut: !1 }),
                  o.model.set({ zoom: !0 }));
            }),
            (o._onChangeStateSlide = function () {
              ...
              t
                ? o.model.get("zoom") && o.model.trigger("zoomOut")
                : r.routeManagerPlus.isList(e) &&
                  n == o.model.path &&
                  (s.modelState.set({ isZoom: !0, isZoomOut: !0 }),
      ...
      p = (function (e) {
        function t(t) {
          ...
          return (
            ...
            (o.addY = 0),
            (o._onStart = function () {
              l.modelState.get("isList") &&
                (o.tweenAdd && o.tweenAdd.kill(),
                (o.addY = 300),
                (o.tweenAdd = TweenMax.to(
                  o,
                  0.8 + d.Random.range(0, 0.4, 0.1),
                  { addY: 0, ease: Ease._4_QuartOut }
            ...
            (o._onJudgeScroll = function () {
              l.modelState.get("isSlide")
                ? o.model.set({ scroll: !1 })
                : o.model.set({ scroll: !0 });
            }),
            ...
            (o._onScrollTo = function () {
              var e, t;
              l.modelState.get("zoomTarget") == o.model.path &&
            ...
            (o._onResize = function () {
              o._updateLayout(),
                ...
                i.resize.changed("clientWidth") &&
                  ((o.currentY = o.targetY),
                  TweenMax.set(o.element, { y: o.currentY + o.addY }));
            }),
            (o._onScroll = function () {
              ...
              if (
                ...
                return (
                  ...
                  e < o.min
                    ? (o.currentY = o.height + o.offsetMax)
                    : (o.currentY = o.height + o.offsetMin),
                  TweenMax.set(o.element, { y: o.currentY + o.addY }),
              ...
              o.hidden &&
                ...
                (o.currentY =
                  t > 0 ? o.height + o.offsetMax : o.height + o.offsetMin),
                TweenMax.set(o.element, { y: o.currentY + o.addY }),
                o.model.updatePosition(o.currentY)),
                t > 0
                  ? t < o.area
            ...
            (o.scale = 1 + d.Random.ranges(0, 0.2, 0.1)),
            (o.zeno = d.Random.range(0.1, 0.15, 0.01)),
        ...
        function e() {
          ...
          (this._setSize = function () {
            ...
            (this._setPosition = function () {
              var e, t, o, i, a, l;
              for (
                s.modelList.offsetX = r.SC.list.offsetLeft,
  ...
  function (e, t, o) {
    "use strict";
    function n(e, t, o, n) {
      var i = n ? [0.1, 0.05, 0] : [0, 0.05, 0.1];
      return (
        TweenMax.set(
          [c.SC.slideHomePosition, c.SC.slideHomeName, c.SC.slideHomeFrom],
          { x: e, y: t }
        ),
        TimelinePlus.seri(
          TimelinePlus.para(
    ...
    function i(e, t, o, n) {
      var i = n ? [0.15, 0.1, 0.05, 0] : [0, 0.05, 0.1, 0.15];
      return (
        TweenMax.set(
          [
            c.SC.slideWorksHeader,
            c.SC.slideWorksTitle,
            c.SC.slideWorksDescription,
            c.SC.slideWorksInfo
          ],
          { x: e, y: t }
        ),
          ...
          (this._onStart = function () {
            ...
            (this._onChangeSlideText = function () {
              var e,
                t,
                o,
                f = u.modelState.get("isSlideText"),
              ...
              f
                ? 0 != m
                  ? ((e = d.ConstWork.list[m - 1]),
                    ...
                    c.SC.slideWorksShareFacebook.setAttribute(
                      "href",
                      e.shareFacebook
                    ),
                    c.SC.slideWorksShareTwitter.setAttribute(
                      "href",
                      e.shareTwitter
                    ),
                    _
                      ? TweenMax.set(
                          ...
                          { autoAlpha: 1, x: 1, y: 1, scaleY: 1 }
                        )
                      : (l && l.kill(), (l = i(v * t, v * o, 0.8, y))))
                  : _
                  ? TweenMax.set(
                      [
                        c.SC.slideHomePosition,
                        c.SC.slideHomeName,
                        c.SC.slideHomeFrom
                      ],
                      { autoAlpha: 1, x: 1, y: 1, scaleY: 1 }
                    )
                  : (a && a.kill(), (a = n(v * t, v * o, 0.8, y)))
                : (a && a.kill(),
                  l && l.kill(),
                  _
                    ? TweenMax.set(
  ...
  function (e, t, o) {
    ...
    var n,
      ...
      d = (function () {
        function e() {
          (this._onChangeDevice = function () {
            "mobile" != l.modelMQ.get("device") &&
              s.modelState.set({ isSlideInfo: !1 });
          }),
            (this._open = function () {
              s.modelState.set({ isSlideInfo: !0 });
            }),
            ...
            (this._onChangeSlideInfo = function () {
              n && n.kill(),
                s.modelState.get("isSlideInfo")
                  ? (s.modelState.set({ isSlideInfoStart: !0 }),
                    (n = TimelinePlus.call(
                      s.modelState.set,
                      [{ isSlideInfoEnd: !0 }],
                      s.modelState
                    ).delay(0.1)),
                    (a.SC.slideInfoScroll.scrollTop = 0))
                  : (s.modelState.set({ isSlideInfoEnd: !1 }),
                    (n = TimelinePlus.call(
                      s.modelState.set,
                      [{ isSlideInfoStart: !1 }],
                      s.modelState
            ...
            (this._onChangeSlideInfoStart = function () {
              ...
              s.modelState.get("isSlideInfoStart") &&
                ((e = c.ConstWork.list[s.modelState.get("slideIndex") - 1]),
                ...
                a.SC.slideInfoShareFacebook.setAttribute(
                  "href",
                  e.shareFacebook
                ),
      ...
      h = (function () {
        function e() {
          (this._onMQ = function () {
            ...
            c.modelNavi.set({ arrowSize: e });
          }),
            (this._onArrowSize = function () {
              var e,
                t,
                o,
                n = c.modelNavi.get("arrowSize");
              switch (n) {
                case 0:
                  (e = "0 0 360 7"),
            ...
            (this._onKeyUp = function (e) {
              ...
              e.shiftKey ||
                ...
                e.metaKey ||
                (39 == t || 40 == t
                  ? r.routeManagerPlus.isSlide(o) &&
                    r.routeManagerPlus.nextSlide(!0)
                  : (37 != t && 38 != t) ||
                    (r.routeManagerPlus.isSlide(o) &&
                      r.routeManagerPlus.prevSlide(!0)));
            }),
            ...
            (this._onChangeSlideText = function () {
              ...
              if (a.modelState.get("isSlideText")) {
                var t = (e + 1) % n,
                  o = (e - 1 + n) % n;
                (i.SC.slideNaviNextNum.textContent =
                  l.ConstSlide.list[t].idString),
                  (i.SC.slideNaviPrevNum.textContent =
                    l.ConstSlide.list[o].idString),
                  i.SC.slideNaviNext.setAttribute(
                    "href",
                    r.routeManagerPlus.getPathBySlideIndex(t)
                  ),
                  i.SC.slideNaviPrev.setAttribute(
                    "href",
                    r.routeManagerPlus.getPathBySlideIndex(o)
                  ),
                  (i.SC.slideNaviNextTitle.textContent =
                    0 == t ? "TAO TAJIMA" : d.ConstWork.list[t - 1].title),
                  (i.SC.slideNaviPrevTitle.textContent =
                    0 == o ? "TAO TAJIMA" : d.ConstWork.list[o - 1].title);
              }
            });
        }
        return (
      ...
      v = (function () {
        function e() {
          ...
          (this._onChangePath = function (e) {
            u.modelState.set({ isSlideVimeo: !1, isSlideVimeoCancel: !0 });
          }),
            (this._onClick = function (t) {
              "computer" == d.modelMQ.get("device") &&
            ...
            (this._open = function () {
              u.modelState.set({ isSlideVimeoCancel: !1, isSlideVimeo: !0 });
            }),
            (this._close = function () {
              u.modelState.set({ isSlideVimeoCancel: !1, isSlideVimeo: !1 });
            }),
            (this._onChangeSlideVimeoStart = function () {
              var t;
              n && n.kill(),
                u.modelState.get("isSlideVimeoStart")
                  ? ((t = p.ConstWork.list[u.modelState.get("slideIndex") - 1]),
                    ...
                    r.ready().then(e._onResize))
                  : (c.SC.slideVimeo.removeChild(s),
                    f.index.off("resize", e._onResize));
            }),
            (this._onChangeSlideVimeoEnd = function () {
              i && i.kill(),
                u.modelState.get("isSlideVimeoEnd")
                  ? (e._onResize(), f.index.on("resize", e._onResize))
                  : (h.routeManagerPlus.trigger("loop"), r.pause());
            }),
            (this._onResize = function () {
              var e, t, o, n, i;
        ...
        return (
          (e.prototype.init = function () {
            Useragnt.pc &&
              (h.routeManagerPlus.on(":path", this._onChangePath),
              d.modelMQ.on(":device", this._onChangeDevice),
              u.modelState.on(
                ":isSlideVimeoStart",
                this._onChangeSlideVimeoStart
              ),
      ...
      h = (function () {
        ...
        return (
          ...
          (e.prototype._setRay = function () {
            i.threeManager.rayCaster.ray.direction
              .set(u, c, 1)
              .unproject(i.threeManager.camera)
              .sub(i.threeManager.camera.position)
              .normalize();
          }),
          e
        );
      ...
      y = (function () {
        function e() {
          ...
          (this._progress1 = 0),
            ...
            (this._onChangeDevice = function () {
              "computer" != p.modelMQ.get("device")
                ? (u.modelState.off(
                    ":isSlideVimeoCancel",
                    e._onChangeSlideVimeoCancel
                  ),
                ...
                u.modelState.get("isSlideVimeo")
                  ? ((r.opacity.value = 1),
                    ...
                    (n = TimelinePlus.seri(
                      ...
                      TimelinePlus.wait(0.05),
                      TimelinePlus.call(e._startComplete)
                    ).eventCallback("onUpdate", e._onUpdate)))
                  : ((l.threeBlack.mesh.visible = !0),
                    c.SC.slideWorksPlay.classList.add("isDelay"),
                    u.modelState.set({ isSlideVimeoEnd: !1 }),
                    (n = TimelinePlus.seri(
                      TimelinePlus.para(
                        TweenMax.to(e, 1, {
                          _progress1: 0,
                      ...
                      TimelinePlus.wait(0.05),
                      TimelinePlus.call(e._endComplete)
                    ).eventCallback("onUpdate", e._onUpdate)),
                    u.modelState.get("isSlideVimeoCancel") &&
                      (i = TweenMax.to(r.opacity, 0.5, {
                        value: 0,
                        ease: Ease._1_SineOut
                      }).delay(0.3))));
            }),
            ...
            (this._onUpdate = function () {
              ...
              (r.progress.value.x = f.smoothStep(0.2, 0.9, t)),
                (r.progress.value.y = f.smoothStep(0.1, 0.8, t)),
                (r.progress.value.z = t);
              var o = f.smoothStep(0, 0.9, t);
              (r.progress.value.w = o < 0.5 ? 2 * o : 2 * (1 - o)),
      ...
      l = (function (e) {
        function t(t) {
          ...
          return (
            (o._onRAF = function (e, t) {
              ++i > 1 &&
                ((o.mesh.visible = !1), r.threeManager.off("draw", o._onRAF));
            }),
            ...
            (o._onChangeVisible = function () {
              o.model.get("visible")
                ? (o._setTexture(), (o.mesh.visible = !0))
                : (o._unsetTexture(), (o.mesh.visible = !1));
            }),
            (o._onVideoPlayDelay = function () {
              o._tweenDelay && o._tweenDelay.kill(),
                (o._tweenDelay = TimelinePlus.call(o._onVideoPlay).delay(0.1));
            }),
            ...
            o.model
              .on("visibleIn", o._onVisibleIn)
              .on(":visible", o._onChangeVisible),
            (i = 0),
            r.threeManager.on("draw", o._onRAF),
            o
          );
            ...
            (this.texture.image = this.video.image),
              ...
              a.C.videoUsing &&
                (this.video.isPlaying
                  ? this._onVideoPlay()
                  : (this.video.once("play", this._onVideoPlayDelay),
                    this.video.resume(0.25)));
          }),
          (t.prototype._unsetTexture = function () {
            a.C.videoUsing &&
              (this.model.get("play") || this.video.pause(),
        ...
        function t(t) {
          ...
          return (
            (o._onZoomIn = function () {
              o.model.set({ zoom: !0, visible: !0 }, { silent: !0 }),
                o.model.trigger("visibleIn"),
                (o.uniforms.progress.value = 1);
            }),
            (o._onZoomOut = function () {
              o.model.set({ zoom: !1, visible: !1 }, { silent: !0 }),
            ...
            (o._onChangeZoom = function () {
              ...
              var e,
                t,
                n = o.model.get("zoomCancel"),
                i = n ? 0.75 : 1.5;
              o.model.get("zoom")
                ? (o._tween = TimelinePlus.seri(
                    TweenMax.to(o.uniforms.progress, i, {
                      value: 1,
                      ease: Ease._3_CubicInOut
                    }),
                    TimelinePlus.call(o._onZoomInComplete)
                  ).eventCallback("onUpdate", o._onUpdate))
                : ((e = new TimelineMax()),
                  ...
                  (o._tween = TimelinePlus.seri(
                    e,
                    TimelinePlus.call(o._onZoomOutComplete)
                  ).eventCallback("onUpdate", o._onUpdate))),
                o.model.set({ visible: !0 });
            }),
            (o._onUpdate = function () {
              var e = 1 - s.smoothStep(0, 0.4, o.uniforms.progress.value);
              TweenMax.set([a.SC.list, a.SC.about], { autoAlpha: e });
            }),
            (o._onZoomInComplete = function () {
              o.model.set({ visible: !1, play: !0 }),
                r.modelState.set({ isZoomIn: !1, isZoom: !1, isSlide: !0 });
            }),
            (o._onZoomOutComplete = function () {
              o.model.set({ visible: !1, play: !1 }),
                r.modelState.set({ isZoomOut: !1, isZoom: !1, isList: !0 });
            }),
            o.model
              .on("zoomIn", o._onZoomIn)
              .on("zoomOut", o._onZoomOut)
              .on(":zoom", o._onChangeZoom),
            o
          );
        }
        return n(t, e), t;
    ...
    var i = o(21),
      ...
      u = (function (e) {
        function t(t) {
          var o = e.call(this, t) || this;
          return (
            (o._onChangeList = function () {
              !l.modelState.get("isList") && o.model.get("hover")
                ? o._stop()
                : o._start();
            }),
            (o._onChangeHover = function () {
              o._tween && o._tween.kill(),
                o.model.get("hover")
                  ? (o.model.set({ visible: !0, play: !0, progress: !0 }),
                    a.modelThreeRayCaster.add(),
                    s.threeManager.on("draw", o._onRAF),
                    (o._tween = TimelinePlus.para(
                      TweenMax.to(o.three, 0.6, {
                        scale: r.C.listHoverScale,
                        ease: Ease._BackOut
                      }),
                      TweenMax.to(o.hover, 0.6, {
                        z: 1,
                        ease: Ease._3_CubicOut
                      })
                    )))
                  : (l.modelState.get("isList") &&
                      o.model.set({ progress: !1 }),
                    (o._tween = TimelinePlus.seri(
                      TimelinePlus.para(
                        TweenMax.to(o.three, 0.7, {
                          scale: 1,
                          ease: Ease._4_QuartOut
                        }),
                        TweenMax.to(o.hover, 0.7, {
                          z: 0,
                          ease: Ease._3_CubicOut
                        })
                      ),
            ...
            (o._hoverOut = function () {
              s.threeManager.off("draw", o._onRAF),
                (l.modelState.get("isList") ||
                  o.model.path != l.modelState.get("zoomTarget")) &&
                  o.model.set({ visible: !1, play: !1 });
            }),
            (o._onRAF = function () {
              var e,
                t = s.threeManager.rayCaster.intersectObject(o.mesh);
              t.length > 0 &&
                ((e = t[0].point),
                o.mesh.worldToLocal(e),
                (o.hover.x = e.x / o.three.constWork.width + 0.5),
                (o.hover.y = e.y / o.three.constWork.height + 0.5));
            }),
            (o._onHover = function () {
              var e = o.model,
        ...
        return (
          ...
          (t.prototype._stop = function () {
            this._tween && this._tween.kill(),
              ...
              (this._tween = TimelinePlus.seri(
                TimelinePlus.para(
                  TweenMax.to(this.three, 1, {
                    scale: 1,
                    ease: Ease._4_QuartOut
                  }),
                  TweenMax.to(this.hover, 1, { z: 0, ease: Ease._3_CubicOut })
                )
              ));
          }),
          t
      ...
      u = (function (e) {
        function t(t) {
          ...
          return (
            (o._onRAF = function (e, t) {
              ++i > 1 &&
                ((o.mesh.visible = !1), s.threeManager.off("draw", o._onRAF));
            }),
            (o._onStart = function () {
              o.model
                .on("visibleIn", o._onVisibleIn)
                .on("visibleOut", o._onVisibleOut)
                .on(":visible", o._onChangeVisible)
                .on("progressIn", o._onProgressIn)
                .on("progressOut", o._onProgressOut)
                .on(":progress", o._onChangeProgress);
            }),
            ...
            (o._onChangeProgress = function () {
              o._tweenUniforms && o._tweenUniforms.kill(),
                o.model.get("progress")
                  ? (o._tweenUniforms = TimelinePlus.seri(
                      TweenMax.to(o.uniforms.progress, 1, {
                        value: 1,
                        ease: Ease._3_CubicOut
                      })
                    ))
                  : (o._tweenUniforms = TimelinePlus.seri(
                      TweenMax.to(o.uniforms.progress, 0.7, {
                        value: 0,
                        ease: Ease._2_QuadInOut
                      })
                    ));
        ...
        function t(t) {
          ...
          return (
            ...
            (o._onChangeZoom = function () {
              ...
              o._onResize(),
                t
                  ? (o.model.set({ active: !0, visible: !0, progress: !0 }),
                    o._tween
                      ? (o._tween.kill(),
                        (e = TimelinePlus.para(
                          TweenMax.to(o, 0.6, {
                          ...
                          TimelinePlus.call(o._zoomInComplete).delay(0.7)
                        )))
                      : (e = TimelinePlus.para(
                          TweenMax.to(o, 1.2, {
                            _progress1: 0.5,
                    ...
                    (o._tween = TimelinePlus.seri(e).eventCallback(
                      "onUpdate",
                      o._onUpdate
                    )))
                  : (o.model.set({ active: !0, visible: !0 }),
                    o._tween
                      ? (o._tween.kill(),
                        (e = TimelinePlus.para(
                          TweenMax.to(o, 0.8, {
                    ...
                    (o._tween = TimelinePlus.seri(
                      e,
                      TimelinePlus.call(o._zoomOutComplete)
                    ).eventCallback("onUpdate", o._onUpdate)));
            }),
            (o._zoomInComplete = function () {
              o._tween.kill(),
                (o._tween = null),
                (o._progress1 = o._progress2 = 0.5),
                o.model.set({ active: !1, visible: !1, play: !0 }),
                r.modelState.set({ isZoomIn: !1, isZoom: !1, isSlide: !0 }),
            ...
            (o._onUpdate = function () {
              var e = o._progress1 + o._progress2,
                t = a.smoothStep(0, 0.9, e);
              (o.uniforms.sway.value = t < 0.5 ? 2 * t : 2 * (1 - t)),
                (o.uniforms.corners.value.x = a.smoothStep2(
                  c[o._random[0]],
                  d,
                  e
                )),
                (o.uniforms.corners.value.y = a.smoothStep2(
                  c[o._random[1]],
                  d,
                  e
                )),
                (o.uniforms.corners.value.z = a.smoothStep2(
                  c[o._random[2]],
                  d,
                  e
                )),
                (o.uniforms.corners.value.w = a.smoothStep2(
                  c[o._random[3]],
                  d,
                  e
                ));
              var n = 1 - a.smoothStep(0.1, 0.6, e);
              TweenMax.set([u.SC.list, u.SC.about], { autoAlpha: n });
            }),
            o.model
              .on(":zoom", o._onChangeZoom)
              .on("zoomIn", o._onZoomIn)
              .on("zoomOut", o._onZoomOut)
              .on("resize", o._onResize),
            o._onResize(),
            (o._random = s.createRandomArray(4)),
            o
          );
      ...
      c = (function (e) {
        function t(t) {
          ...
          return (
            ...
            (o._onRAF = function (e, t) {
              ++i > 1 &&
                ((o.mesh.visible = !1), l.threeManager.off("draw", o._onRAF));
            }),
            ...
            (o._opening = function () {
              s.modelState.get("isSlide") &&
                ((o.uniforms.mask.value.x = 0),
                (o.uniforms.mask.value.y = 0),
                (o.uniforms.mask.value.z = 0),
                TimelinePlus.seri(
                  TimelinePlus.para(
                    TweenMax.to(o, 1.2, { mask1: 1, ease: Ease._4_QuartInOut }),
                    TweenMax.to(o, 1.3, {
                      mask2: 1,
                      ease: Ease._3_CubicInOut
                    }).delay(0.2)
                  ),
                  TimelinePlus.set(o, { mask2: 0 })
                ).eventCallback("onUpdate", o._openingComplete));
            }),
            (o._openingComplete = function () {
              (o.uniforms.mask.value.x = o.mask1),
                (o.uniforms.mask.value.y = a.smoothStep(0, 0.4, o.mask1)),
        ...
        function t(t) {
          ...
          return (
            (o._onOpening = function () {
              ...
              o.model.set({ texture1: e - 1, texture2: e - 1 }),
                o.model.on(":visible", o._onChangeVisible),
            ...
            (o._onChangeVimeoEnd = function () {
              P.modelState.get("isSlideVimeoEnd")
                ? (u.pause(), c.pause())
                : (u.resume(), c.resume());
            }),
            (o._onChangeSlide = function () {
              var e;
              P.modelState.get("isSlide") ||
                ((e =
                  E.routeManagerPlus.getSlideIndexByPath(
                    P.modelState.get("zoomTarget")
                  ) - 1),
                o._unsetTextures(e, e));
            }),
            (o._onChangeVisible = function () {
              o.model.get("visible")
                ? (o.model.on(":", o._onChangeModel),
                  S.index.on("resize", o._onResize),
                  o._onResize(),
                  o._updateTexture())
                : (o.model.off(":", o._onChangeModel),
                  S.index.off("resize", o._onResize));
            }),
            (o._onChangeModel = function () {
              o.model.changedAny(["texture1", "texture2"]) &&
                o._updateTexture();
            }),
            ...
            (o._onVideoPlayDelay1 = function () {
              p && p.kill(),
                (p = TimelinePlus.call(o._onVideoPlay1).delay(0.2));
            }),
            (o._onVideoPlayDelay2 = function () {
              f && f.kill(),
                (f = TimelinePlus.call(o._onVideoPlay2).delay(0.2));
            }),
          ...
          (t.prototype._setTexture1 = function () {
            (m.image = u.image),
              ...
              C.C.videoUsing &&
                (u.isPlaying
                  ? this._onVideoPlay1()
                  : (u.once("play", this._onVideoPlayDelay1), u.resume(0.25)));
          }),
          (t.prototype._setTexture2 = function () {
            (v.image = c.image),
              ...
              C.C.videoUsing &&
                (c.isPlaying
                  ? this._onVideoPlay2()
                  : (c.once("play", this._onVideoPlayDelay2), c.resume(0.25)));
          }),
          t
        );
    ...
    var n,
      ...
      u = (function () {
        ...
        return (
          (e.prototype.init = function () {
            return (
              (i = a.threeText.uniformsCurrent.opacity),
              ...
              if ("" != l) {
                ...
                t
                  ? (n(),
                    ...
                    r && r.kill(),
                    (r = TimelinePlus.seri(
                      TweenMax.to(a.progress, 1.6, {
                        value: 0,
                        ease: Ease._3_CubicOut
                      }),
                      TimelinePlus.call(e._onCompleteIn)
                    )))
                  : ((d.visible = !0),
                    (a.progress.value = 0),
                    (a.offset.value.x = -80 * o),
            ...
            (this._onChangeCanvasText = function () {
              ...
              if (m.modelState.get("isSlideText") && "" != e) {
                var t = "large" == e ? _.CanvasText.large : _.CanvasText.short,
                  o = new THREE.PlaneBufferGeometry(
                    t.width,
                    t.height,
                    Math.round(t.width / 5),
                    Math.round(t.height / 5)
                  );
                (d.geometry = o),
        ...
        function t() {
          ...
          return (
            (t._onErrorXHR = function () {
              t._cleanXHR(),
                ++t.retry < 5 &&
                  (t.retry % 2 == 0 ? t._loadXHR(t.src1) : t._loadXHR(t.src2));
            }),
            (t._onReadyXHR = function () {
        ...
        return (
          ...
          (t.prototype._loadXHR = function (e) {
            (this.xhr = new XMLHttpRequest()),
              1 == ("string" == typeof this.xhr.responseType ? 2 : 1) &&
                this.xhr.setRequestHeader("Origin", location.origin),
          ...
          return (
            (t._load = function () {
              ...
              e.once("ready", t._onReady),
                ...
                ++t._connection,
                ++t._loading < t._total &&
                  t._connection < r.C.videoMaxConnection &&
                  t._load();
            }),
            (t._onReady = function () {
              --t._connection,
    ...
    var n = o(4),
      ...
      u = (function () {
        function e(e, t) {
          var o = this;
          return (
            (this.positionHover = new THREE.Vector2()),
            ...
            (this._onRAF = function (e, t) {
              if (o.mesh.visible) {
                ...
                o.mesh.position.set(
                  (o.position.x + o.positionHover.x) / o.scale,
                  (o.position.y + o.positionHover.y) / o.scale,
                  -(i - i / o.scale)
                );
              }
            }),
            ...
            (this.constWork = t),
            this._initThree(),
            (this.controllerVisible = new s.ControllerThreeListItemVisible(
              this
            )),
            (this.controllerPosition = new i.ControllerThreeListItemPosition(
              this
            )),
            Useragnt.pc &&
              (this.controllerHover = new r.ControllerThreeListItemHover(this)),
        ...
        return (
          (e.prototype._initThree = function () {
            (this.geometry = new THREE.PlaneBufferGeometry(
              this.constWork.width,
              this.constWork.height,
              Math.round(this.constWork.width / 10),
              Math.round(this.constWork.height / 10)
            )),
            ...
            var e = {
                ...
                textureSize: {
                  value: new THREE.Vector4(
                    this.constWork.width,
                    this.constWork.height,
                    this.constWork.width / this.constWork.height
                  )
                },
                opacity: { value: 1 },
                hover: { value: new THREE.Vector3(0.5, 0.5, 0) },
                corners: { value: new THREE.Vector4(0, 0, 0, 0) },
                sway: { value: 0 },
                zoomScale: { value: 0 },
                rotation: { value: 0 },
                progress: { value: 0 },
                translate: { value: new THREE.Vector2(-0.2, 0.4) },
                delay: { value: new THREE.Vector2(1, 1) },
                edge: { value: 0 },
                accel: { value: new THREE.Vector2(2, 2) },
                waveAmpFreq: { value: new THREE.Vector4(0, 0.5, 0, 4) },
                waveSpeedPhase: { value: new THREE.Vector4(0, 0.3, 0, 0) },
                waveBlend: { value: new THREE.Vector2(0.2, 0.8) }
              },
              t = new THREE.RawShaderMaterial({
                blending: THREE.NormalBlending,
                side: THREE.FrontSide,
